    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("[26]Range Repeat Empty Method: ");
                Console.WriteLine("[27]Append Prepend ZIP: ");
                Console.WriteLine("[28]Dictionary: ");
                Console.WriteLine("[29]Of Type: ");
                ...
                switch (caseSwitch)
                {
                    ...
                    case 27:
                        Console.WriteLine("\n****** Append Prepend ZIP********");
                        AppendPrependMethod.GetAppendPrependMethod();
                        Console.WriteLine("\n**************");
                        break;
                    case 28:
                        Console.WriteLine("\n****** Dictionary ********");
                        ToDictionaryMethod.GetToDictionaryMethod();
                        Console.WriteLine("\n**************");
                        break;
                    case 29:
                        Console.WriteLine("\n****** Of Type ********");
                        OfTypeMethod.GetOfTypeMethod();
                        Console.WriteLine("\n**************");
                        break;
                    default:
